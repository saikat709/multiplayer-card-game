...
export const Card = ({type = "shield", ...props}) => {
  const { nodes, materials } = useGLTF('/models/card.glb')
  const textTure = useTexture(`/cards/${type}.jpg`);
  ...
  return (
    <group {...props} dispose={null}>
        <mesh 
            ...
            >
            <meshStandardMaterial {...materials.Front} map={textTure} color="white"/>
        </mesh>
        <mesh
            castShadow
            receiveShadow
...
useTexture.preload(`/cards/steal.jpg`);